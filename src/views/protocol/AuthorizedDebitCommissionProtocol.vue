<template>
  <div>
    <h1 align="center">授权扣款委托书</h1>
    <p>授权人：{{this.name}}</p>
    <p>被授权人：深圳前海贷贷通互联网金融服务有限公司</p>
    <div style="text-indent:2em">
      ...
      <p>1、没有逾期的，还款金额为借款合同金额；</p>
      <p>2、选择提前结清的，需一次性偿还借款合同金额；</p>
      <p>3、发生逾期时还款顺序依次为逾期管理费、借款合同金额。</p>
      ...
      <p>联系手机：{{this.tel}}</p>
      <p>借记卡户名：{{this.card_name}}</p>
      <p>借记卡开户银行：{{this.card_bank}}</p>
      <p>借记卡账号：{{this.card_no}}</p>
      <p>（以下无正文）：</p>
      <p>授权人：{{this.name}}</p>
      <p>被授权人：深圳前海贷贷通互联网金融服务有限公司：</p>
      <p>{{this.apply_date}}</p>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.tel = typeof(queryParams.tel) === "undefined" ? "" : queryParams.tel;
      this.card_name = typeof(queryParams.card_name) === "undefined" ? "" : queryParams.card_name;
      this.card_bank = typeof(queryParams.card_bank) === "undefined" ? "" : queryParams.card_bank;
      this.card_no = typeof(queryParams.card_no) === "undefined" ? "" : queryParams.card_no;
